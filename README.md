...
User Interaction: Testing included pressing different keys to ensure the game responds as expected, particularly the keypress to start the wheel and click to quit.
...
Since many of my code use GUI, so I can not write a test code for all of my codes, but I still test some of them, and pass all tests.
...
Reflecting on the experience of creating a "Wheel of Fortune" game using Pygame, I've gained a wealth of knowledge and insights. My journey began with understanding the basics of Pygame, an essential step that laid the foundation for game development. This included initializing Pygame, creating a game window, and managing the game loop, all of which are critical for any game development process.
Event handling was another key area of learning. I learned to manage various events in Pygame, such as quitting the game and detecting key presses, which are fundamental for interactive gameplay. Additionally, the project allowed me to delve into graphics and animations. I learned how to load, transform, and display images, and create basic animations. This was particularly important for making the wheel spin and displaying the hand pointer, adding a dynamic aspect to the game.
A significant part of this project involved applying mathematical concepts, especially trigonometry, to create the spinning motion of the wheel hand. This was a practical demonstration of how mathematics can be intricately linked with programming to produce visual effects. Furthermore, I developed the core logic of the game, which involved random prize selection and displaying the result to the player. This not only tested my programming skills but also my ability to think logically and systematically.
However, this project also highlighted areas where further learning is needed. I realized the importance of exploring advanced Pygame features like sound effects, music, and complex animations to enhance the gaming experience. Understanding game physics for more realistic animations, improving UI/UX design skills for better player interaction, and learning optimization techniques for better game performance are some areas I plan to focus on. Additionally, ensuring cross-platform compatibility is crucial for broader game accessibility.

I have learned a lot of knowledge through this semester's study. I think 5001 ( include 5003 ) is a very good Bridge course that really introduced me to the world of computer science. And I think Mr. Albert is a very good teacher. He can arrange classes and leisure time for us flexibly. The pressure of study is not too great, but we can really learn skills. And the things taught are closely related to future employment, which is of great benefit to our personal development and job hunting in the future. 
