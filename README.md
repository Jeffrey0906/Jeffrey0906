...
Since many of my code use GUI, so I can not write a test code for all of my code, but I still test the first reward_fun function, and it passes all three tests.
